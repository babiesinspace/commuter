...
ActiveRecord::Schema.define(version: 2018_05_29_194428) do

  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "commute_occurrences", force: :cascade do |t|
    t.string "schedulable_type"
    t.bigint "schedulable_id"
    t.datetime "date"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["schedulable_type", "schedulable_id"], name: "idx_com_occur_on_sched_type_and_sched_id"
  end
